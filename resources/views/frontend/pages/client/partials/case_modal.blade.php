                                    ...
                                    <div class="d-flex align-items-center ms-2"
                                        ...
                                        <div class="d-flex">
                                            @foreach ($teams as $team)
                                                <div class="col-lg-3 form-check form-check-inline mx-2 my-2">
                ...
                <div class="modal-body px-5">
                    <div class="row align-items-center mb-3 gx-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center ms-2"
                                    ...
                                    <div class="">
                                        @foreach ($teams as $team)
                                            <div class="form-check form-check-inline mx-2 my-2">
                                                <input class="form-check-input" name="mail_cc[]" type="checkbox"
                        ...
                        <div class="col-lg-12 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="">
                                    <label class="form-label mt-3 me-1">Sub<span class="text-danger">*</span>
                                    </label>
                                </div>
                                <div class="w-100">
                                    <input type="text" class="form-control form-control-sm border-0"
