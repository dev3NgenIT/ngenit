            ...
            @if (!empty($whatwedo))
                <div class="row align-items-center">
                    <div class="col-lg-7 py-5">
                        <div>
                            <h1 class="mb-4" style="font-size: 2.8rem">{{ $whatwedo->bannner_title }}</h1>
                            <p class="text-white" style="text-align: justify;">{!! $whatwedo->bannner_description !!} </p>
                            <a class="common_button3 py-3 mt-3" href="{{ route('contact') }}">Talk with us</a>
                        </div>
                    </div>
                    <div class="col-lg-5">
        ...
        <div class="container">
            @if (!empty($whatwedo->row_one_header))
                <div class="pt-3">
                    ...
                    <h4 class="text-center px-5 pb-3"> {!! $whatwedo->row_one_short_description !!} </h4>
                </div>
            @endif
            {{-- Shop Product Added --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-sm-12 pb-3">
                            <div class="home_shop_product_wrapper">
                                ...
                                <div class="d-flex justify-content-start mt-5 solution_sidebar">
                                    <a href="{{ route('shop.html') }}" class="common_button effect01">Online Shop</a>
                                </div>
                            </div>
                        </div>
                        <!-- product brand -->
                        <div class="col-lg-4 col-sm-12 d-flex justify-content-end solution_sidebar">
                            <div>
                                <div class="">
                            ...
                            <div class="row gx-3">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <a href="{{ $whatwedo->row_one_btn_one_link }}">
                                        <p class="text-center px-2 py-4 service_card">
