    ...
    <div class="fab-info-icon-wrapper">
        ...
        <div class="fab-info-icon-wheel">
            <a href="" class="fab-info-icon-action fab-info-icon-action-1" data-title="RFQ">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115.84 110.29" style="height: 35px;
                padding-top: 8px;">
                    <defs>
                        <style>
                            .cls-1 {
            ...
            <a href="" class="fab-info-icon-action fab-info-icon-action-3" data-title="Contact">
                <i class="fas fa-address-book"></i>
            </a>
            <a href="" class="fab-info-icon-action fab-info-icon-action-4" data-title="RFQ">
